Feature: code-breaker submits guess
	...
	tha mark includes one - sign.

	Each position in the secret code can only be matched once. For example, a guess of 1134 
	against a secret code of 1234 would get three plus signs:
	...
	Scenario Outline: submit guess
		...
		Scenarios: mathes with duplicates
			| code | guess | mark | 
			| 1234 | 1155  | +    | 
			| 1234 | 5115  | -    | 
			| 1134 | 1155  | ++   | 
